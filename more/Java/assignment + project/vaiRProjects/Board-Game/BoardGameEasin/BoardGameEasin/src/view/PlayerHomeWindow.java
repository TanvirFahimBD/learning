 ...
 * @author FURIOUS
 */
public class PlayerHomeWindow extends AbstractFrame {
    ...
    public PlayerHomeWindow() {
        ...
        lblPrefferedCatagory.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                PlayerHomeWindow.frame.dispose();
                ...
                btnShowPlayerList.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        for (int x = 0; x < Hours.getHourList().length; x++) {
                            if (Hours.getHourList()[x].equals(fromTime)) {
                        ...
                        for (int x = 0; x < Hours.getHourList().length; x++) {
                            if (Hours.getHourList()[x].equals(toTime)) {
                        ...
                        for (int x = currentPlayerStartTimeIndex; x < currentPlayerEndTimeIndex; x++) {
                            startTimeList[x - currentPlayerStartTimeIndex] = Hours.getHourList()[x];
                        }
                            ...
                            public void actionPerformed(ActionEvent e) {
                                ...
                                for (int i = 0; i < startTimeList.length; i++) {
                                    ...
                                    if (bookmarkTitle == null || bookmarkTitle.isEmpty()) {
                                        ...
                                        manager.insertData(sql, bookmarkTitle, bookmarkQueryString, PlayerLoginForm.getCurrentPlayer());
                                        isBlank = false;
                                    }
                                }
                                if (isBlank == true) {
                        ...
                        public void mouseClicked(MouseEvent e) {
                            try {
                                ...
                                if (bookmarkTitle.isEmpty()) {
                                    ...
                                    ArrayList<HashMap<String, String>> al = manager.getQueryData(sql, bookmarkTitle, PlayerLoginForm.getCurrentPlayer());
                                    for (int i = 0; i < al.size(); i++) {
                                        ArrayList<HashMap<String, String>> al2 = manager.getQueryData(al.get(i).get("bookmarkSql"));
                                        for (int j = 0; j < al2.size(); j++) {
//                                            try {
                                                dlm.addElement(al2.get(j).get("playerName"));
//                                            } catch (IndexOutOfBoundsException ex) {
//                                                JOptionPane.showMessageDialog(PlayerHomeWindow.frame, "Some data are missing.");
//                                            }
                                        }
                                    }
                                }
                                ...
                                JOptionPane.showMessageDialog(frame, "Bookmark title is not inserted.");
                            }
                        }
    ...
    private void initComponents() {
        ...
        tpPlayerProfile.setBackground(new java.awt.Color(51, 102, 255));
        ...
        btnEditProfile.setBackground(new java.awt.Color(51, 102, 255));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        this.dispose();
        PlayerLoginForm.setCurrentPlayer(-1);
        new PlayerLoginForm().setVisible(true);
    ...
    private void btnEditProfileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditProfileActionPerformed
        ...
        EditPlayerProfile ep = new EditPlayerProfile(playerName, playerEmail, playerLocation, fromTime, toTime, optimalNumbers, password);
        ep.setVisible(true);
